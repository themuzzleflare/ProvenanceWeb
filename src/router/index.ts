...
const routes: Array<RouteRecordRaw> = [
  ...
  },
  {
    ...
    component: () =>
      import(/* webpackChunkName: "transactionsByCategory" */ '@/views/TransactionsByCategory.vue')
  },
  {
  ...
  },
  {
    ...
    component: () => import(/* webpackChunkName: "transactionTags" */ '@/views/TransactionTags.vue')
  },
  {
    path: '/:pathMatch(.*)*',
    redirect: '/404'
